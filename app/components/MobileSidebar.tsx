...
export default function MobileSidebar() {
  ...
  return (
    <>
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50 p-4 flex items-center justify-between">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="fixed left-0 top-0 bottom-0 w-64 bg-gray-100 z-50 md:hidden overflow-y-auto">
